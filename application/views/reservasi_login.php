      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-sm-9 mx-auto mt-5">
            ...
            <input type="hidden" class="form-control" name="id_kamar" value="<?=$_POST['id_kamar'];?>" >
            <input type="hidden" class="form-control" name="tgl_reservasi_masuk"  value="<?=$_POST['tgl_reservasi_masuk'];?>">
            <input type="hidden" class="form-control" name="tgl_reservasi_keluar"  value="<?=$_POST['tgl_reservasi_keluar'];?>">
