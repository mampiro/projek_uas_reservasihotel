...
class Admin extends CI_Controller{
	...
	function index(){
		...
		order by a.id_reservasi desc ")->result();
	...
	function all_reservasi(){
		$data['reservasi'] = $this->db->query('select a.*,b.*,c.* from reservasi a 
	 	join kamar b on a.id_kamar=b.id_kamar join reservasi_pembayaran c on a.id_reservasi=c.id_reservasi 
		where b.status_reservasi=2 order by b.status_reservasi desc')->result();
